...
/*
 * Esta clase implementa las interfaces de Identity para manejo de usuarios
 * A su vez en el constructor inyectamos una Interfaz en la cual están nuestras querys
 */
namespace ManejoPresupuesto.Servicios
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        ...
        {
            return await repositorioUsuarios.BuscarUsuarioPorMail(normalizedEmail);
        }
        ...
        {
            return await repositorioUsuarios.BuscarUsuarioPorMail(normalizedUserName);
