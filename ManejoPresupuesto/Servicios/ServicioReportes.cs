...
namespace ManejoPresupuesto.Servicios
{
    ...
    {
        Task<ReporteTransaccionesDetalladas> ObtenerRepoorteTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int mes, int anio, dynamic ViewBag);
    ...
    public class ServicioReportes: IServicioReportes
    {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerRepoorteTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId,
