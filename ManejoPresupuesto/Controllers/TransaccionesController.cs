...
namespace ManejoPresupuesto.Controllers
{
    ...
    public class TransaccionesController : Controller
    {
        ...
        public async Task<FileResult> ExportarPorMes(int mes, int anio)
        {
        ...
        public async Task<FileResult> ExportarPorAnio (int anio)
        {
        ...
        public async Task<FileResult> ExportarTodo(int anio)
        {
