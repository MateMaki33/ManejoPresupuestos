...
namespace ManejoPresupuesto.Controllers
{
    public class CuentasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                TipoCuenta = grupo.Key, //Key = TipoCuenta
        ...
        public async Task<IActionResult> Detalle(int id, int mes, int anio)
        {
            ...
            var modelo = await servicioReportes.ObtenerRepoorteTransaccionesDetalladasPorCuenta(usuarioId, id, mes, anio, ViewBag);
        ...
        {
            var tiposCuentas = await repositorioTiposCuentas.Obtener(usuarioId);
            return tiposCuentas.Select(x => new SelectListItem(x.Nombre, x.Id.ToString())); // (nombre q se muestra, valor que es posteado)
        ...
        public async Task<IActionResult> Editar(int id)
        {
            ...
            //mapper permite mapear objetos de una clase a otra.
            //Se añade a servivios en program.cs para inyeccion
            //Creamos un servicio con el mapeo 
            //Inyectamos al controlador
